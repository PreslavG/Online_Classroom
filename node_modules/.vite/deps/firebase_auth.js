...
async function _reloadWithoutSaving(user) {
  ...
  _assert(response == null ? void 0 : response.users.length, auth, "internal-error");
...
var ActionCodeURL = class {
  constructor(actionLink) {
    ...
    const apiKey = (_a = searchParams["apiKey"]) != null ? _a : null;
    const code = (_b = searchParams["oobCode"]) != null ? _b : null;
    const operation = parseMode((_c = searchParams["mode"]) != null ? _c : null);
    _assert(apiKey && code && operation, "argument-error");
    this.apiKey = apiKey;
    this.operation = operation;
    this.code = code;
    this.continueUrl = (_d = searchParams["continueUrl"]) != null ? _d : null;
    this.languageCode = (_e = searchParams["lang"]) != null ? _e : null;
    this.tenantId = (_f = searchParams["tenantId"]) != null ? _f : null;
  }
...
function _setActionCodeSettingsOnRequest(auth, request, actionCodeSettings) {
  var _a;
  _assert(((_a = actionCodeSettings.url) == null ? void 0 : _a.length) > 0, auth, "invalid-continue-uri");
...
function getMultiFactorResolver(auth, error) {
  ...
  _assert((_a = errorInternal.customData._serverResponse) == null ? void 0 : _a.mfaPendingCredential, authModular, "argument-error");
      ...
      if ("phoneNumber" in phoneInfoOptions) {
        ...
        const startEnrollPhoneMfaActionCallback = async (authInstance, request) => {
          if (request.phoneEnrollmentInfo.captchaResponse === FAKE_TOKEN) {
            _assert((verifier == null ? void 0 : verifier.type) === RECAPTCHA_VERIFIER_TYPE, authInstance, "argument-error");
...
var BrowserPopupRedirectResolver = class {
  ...
  async initAndGetManager(auth) {
    ...
    iframe.register("authEvent", (iframeEvent) => {
      _assert(iframeEvent == null ? void 0 : iframeEvent.authEvent, auth, "invalid-auth-event");
...
var TotpMultiFactorGenerator = class {
  ...
  static async generateSecret(session) {
    ...
    _assert(typeof ((_a = mfaSession.user) == null ? void 0 : _a.auth) !== "undefined", "internal-error");
