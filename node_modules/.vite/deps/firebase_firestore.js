...
var __PRIVATE_FirebaseAuthCredentialsProvider = class {
  ...
  getToken() {
    ...
    return this.forceRefresh = false, this.auth ? this.auth.getToken(t).then((t2) => this.i !== e ? (__PRIVATE_logDebug("FirebaseAuthCredentialsProvider", "getToken aborted due to token change."), this.getToken()) : t2 ? (__PRIVATE_hardAssert("string" == typeof t2.accessToken, 31837, {
      l: t2
...
var __PRIVATE_SimpleDbTransaction = class {
  ...
  constructor(e, t) {
    this.action = e, this.transaction = t, this.aborted = false, this.S = new __PRIVATE_Deferred(), this.transaction.oncomplete = () => {
      this.S.resolve();
  ...
  async runTransaction(e, t, n, r) {
    ...
    for (; ; ) {
      ...
      try {
        ...
        const t2 = __PRIVATE_SimpleDbTransaction.open(this.db, e, i ? "readonly" : "readwrite", n), s2 = r(t2).next((e2) => (t2.C(), e2)).catch((e2) => (t2.abort(e2), PersistencePromise.reject(e2))).toPromise();
        return s2.catch(() => {
        }), await t2.D, s2;
      } catch (e2) {
        ...
        if (r2 !== n) {
          ...
          wt == null ? void 0 : wt.lt(function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e2, t2, n3, r3, i3) {
            ...
            o && (s.bloomFilter = {
              ...
              padding: (_f = (_e2 = o == null ? void 0 : o.bits) == null ? void 0 : _e2.padding) != null ? _f : 0,
              mightContain: (e3) => {
                var _a2;
...
function __PRIVATE_fromWatchChange(e, t) {
  ...
  if ("targetChange" in t) {
    ...
    const r = function __PRIVATE_fromWatchTargetChangeState(e2) {
      ...
      return e2.useProto3Json ? (__PRIVATE_hardAssert(void 0 === t2 || "string" == typeof t2, 58123), ByteString.fromBase64String(t2 || "")) : (__PRIVATE_hardAssert(void 0 === t2 || t2 instanceof Buffer || t2 instanceof Uint8Array, 16193), ByteString.fromUint8Array(t2 || new Uint8Array()));
...
function __PRIVATE_encodeKeySafeBytes(e) {
  return isSafariOrWebkit() ? function __PRIVATE_encodeUint8ArrayToSortableString(e2) {
    let t = "";
    for (let n = 0; n < e2.length; n++)
...
function __PRIVATE_computeInExpansion(e) {
  ...
  if (__PRIVATE_hardAssert(e instanceof FieldFilter || e instanceof CompositeFilter, 20012), e instanceof FieldFilter) {
    if (e instanceof __PRIVATE_InFilter) {
      ...
      return CompositeFilter.create(t2, "or");
    }
    return e;
  }
...
function __PRIVATE_applyDistribution(e, t) {
  let n;
  return __PRIVATE_hardAssert(e instanceof FieldFilter || e instanceof CompositeFilter, 38388), __PRIVATE_hardAssert(t instanceof FieldFilter || t instanceof CompositeFilter, 25473), n = e instanceof FieldFilter ? t instanceof FieldFilter ? function __PRIVATE_applyDistributionFieldFilters(e2, t2) {
...
var __PRIVATE_IndexedDbIndexManager = class {
  constructor(e, t) {
    this.databaseId = t, this.vn = new __PRIVATE_MemoryCollectionParentIndex(), this.Fn = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), (e2, t2) => __PRIVATE_targetEquals(e2, t2)), this.uid = e.uid || "";
  }
  addToCollectionParentIndex(e, t) {
    if (!this.vn.has(t)) {
...
var __PRIVATE_IndexedDbLruDelegateImpl = class {
  ...
  Sr(e, t) {
    ...
    return n.ee({
      ...
      0 === e2 ? (i !== __PRIVATE_ListenSequence.ce && t(new DocumentKey(__PRIVATE_decodeResourcePath(r)), i), i = o, r = s) : i = __PRIVATE_ListenSequence.ce;
    }).next(() => {
...
var __PRIVATE_IndexedDbRemoteDocumentCacheImpl = class {
  ...
  Fr(e, t, n) {
    ...
    return __PRIVATE_remoteDocumentsStore(e).ee({
      ...
      o && o.isEqual(i2) && (n(o, t2), o = s.hasNext() ? s.getNext() : null), o ? r2.j(__PRIVATE_dbKey(o)) : r2.done();
    }).next(() => {
      for (; o; )
...
var __PRIVATE_IndexedDbRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
  constructor(e, t) {
    super(), this.Nr = e, this.trackRemovals = t, this.Br = new ObjectMap((e2) => e2.toString(), (e2, t2) => e2.isEqual(t2));
  }
  applyChanges(e) {
    const t = [];
  ...
  getAllFromCache(e, t) {
    return this.Nr.Mr(e, t).next(({ documents: e2, Or: t2 }) => (t2.forEach((t3, n) => {
      this.Br.set(t3, {
        size: n,
  ...
  Fi(e, t) {
    ...
    return n.J().next((e2) => {
      ...
      return e2.forEach((e3) => {
        var _a;
        let t2 = (_a = n2.get(e3.userId)) != null ? _a : __PRIVATE_documentKeySet();
...
var __PRIVATE_IndexedDbPersistence = class {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 18) {
    if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this.Mi = i, this.window = s, this.document = o, this.xi = a, this.Oi = u, this.Ni = c, this.ci = null, this.li = false, this.isPrimary = false, this.networkEnabled = true, this.Bi = null, this.inForeground = false, this.Li = null, this.ki = null, this.qi = Number.NEGATIVE_INFINITY, this.Qi = (e2) => Promise.resolve(), !__PRIVATE_IndexedDbPersistence.v())
  ...
  Wi() {
    return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (e) => __PRIVATE_clientMetadataStore(e).put({
      ...
      if (!this.allowTabSynchronization)
        throw e;
      return __PRIVATE_logDebug(Lt, "Releasing owner lease after error during lease refresh", e), false;
    }).then((e) => {
  ...
  async shutdown() {
    this.li = false, this.cs(), this.ki && (this.ki.cancel(), this.ki = null), this.ls(), this.hs(), await this.Ui.runTransaction("shutdown", "readwrite", [Y, we], (e) => {
  ...
  zi() {
    ...
    "function" == typeof ((_a = this.window) == null ? void 0 : _a.addEventListener) && (this.Bi = () => {
      ...
      isSafari() && (navigator.appVersion.match(e) || navigator.userAgent.match(e)) && this.Mi.enterRestrictedMode(true), this.Mi.enqueueAndForget(() => this.shutdown());
...
var __PRIVATE_LocalStoreImpl = class {
  constructor(e, t, n, r) {
    this.persistence = e, this.Fs = t, this.serializer = r, this.Ms = new SortedMap(__PRIVATE_primitiveComparator), this.xs = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), __PRIVATE_targetEquals), this.Os = /* @__PURE__ */ new Map(), this.Ns = e.getRemoteDocumentCache(), this.Pi = e.getTargetCache(), this.Ii = e.getBundleCache(), this.Bs(n);
  }
  Bs(e) {
    ...
    return function __PRIVATE_applyWriteToRemoteDocuments(e3, t2, n2, r2) {
      ...
      return s.forEach((e4) => {
        o = o.next(() => r2.getEntry(t2, e4)).next((t3) => {
          ...
          __PRIVATE_hardAssert(null !== s2, 48541), t3.version.compareTo(s2) < 0 && (i2.applyToRemoteDocument(t3, n2), t3.isValidDocument() && (t3.setReadTime(n2.commitVersion), r2.addEntry(t3)));
        });
...
var __PRIVATE_SharedOnlineState = class {
  ...
  static Ws(e) {
    ...
    return "object" == typeof t && -1 !== ["Unknown", "Online", "Offline"].indexOf(t.onlineState) && "string" == typeof t.clientId ? new __PRIVATE_SharedOnlineState(t.clientId, t.onlineState) : (__PRIVATE_logError(jt, `Failed to parse online state: ${e}`), null);
  }
};
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r, i) {
    this.window = e, this.Mi = t, this.persistenceKey = n, this.Js = r, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.Hs = this.Ys.bind(this), this.Zs = new SortedMap(__PRIVATE_primitiveComparator), this.started = false, this.Xs = [];
    const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.eo = createWebStorageClientStateKey(this.persistenceKey, this.Js), this.no = function createWebStorageSequenceNumberKey(e2) {
      return `firestore_sequence_number_${e2}`;
    }(this.persistenceKey), this.Zs = this.Zs.insert(this.Js, new __PRIVATE_LocalClientState()), this.ro = new RegExp(`^${Wt}_${s}_([^_]*)$`), this.io = new RegExp(`^${Gt}_${s}_(\\d+)(?:_(.*))?$`), this.so = new RegExp(`^${zt}_${s}_(\\d+)$`), this.oo = function createWebStorageOnlineStateKey(e2) {
  ...
  async start() {
    ...
    for (const e2 of this.Xs)
      this.Ys(e2);
    this.Xs = [], this.window.addEventListener("pagehide", () => this.shutdown()), this.started = true;
  }
...
var __PRIVATE_WebChannelConnection = class extends __PRIVATE_RestConnection {
  ...
  T_(e, t, n) {
    ...
    void 0 !== a && (_.longPollingTimeout = Math.round(1e3 * a)), this.useFetchStreams && (_.useFetchStreams = true), this.jo(_.initMessageHeaders, t, n), _.encodeInitMessageHeaders = true;
    const u = i.join("");
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (s2) {
          ...
          void 0 === n3 && (n3 = N.INTERNAL, i3 = "Unknown error status: " + t3 + " with message " + s2.message), h = true, P.a_(new FirestoreError(n3, i3)), c.close();
        } else
...
var __PRIVATE_OnlineStateTracker = class {
  ...
  set(e) {
    this.Pa(), this.oa = 0, "Online" === e && (this.aa = false), this.ca(e);
  }
  ca(e) {
...
var __PRIVATE_RemoteStoreImpl = class {
  constructor(e, t, n, r, i) {
    this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.Ta = [], this.Ia = /* @__PURE__ */ new Map(), this.Ea = /* @__PURE__ */ new Set(), this.da = [], this.Aa = i, this.Aa.Oo((e2) => {
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  if (e.Ra.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause)
    try {
...
async function __PRIVATE_eventManagerUnlisten(e, t) {
  ...
  if (s) {
    ...
    e2 >= 0 && (s.Sa.splice(e2, 1), 0 === s.Sa.length ? i = t.Da() ? 0 : 1 : !s.ba() && t.Da() && (i = 2));
  }
  switch (i) {
    case 0:
...
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.Pu = {}, this.Tu = new ObjectMap((e2) => __PRIVATE_canonifyQuery(e2), __PRIVATE_queryEquals), this.Iu = /* @__PURE__ */ new Map(), this.Eu = /* @__PURE__ */ new Set(), this.du = new SortedMap(DocumentKey.comparator), this.Au = /* @__PURE__ */ new Map(), this.Ru = new __PRIVATE_ReferenceSet(), this.Vu = {}, this.mu = /* @__PURE__ */ new Map(), this.fu = __PRIVATE_TargetIdGenerator.cr(), this.onlineState = "Unknown", this.gu = void 0;
  }
  get isPrimaryClient() {
    return true === this.gu;
  }
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
  e.pu = (t2, n2, r2) => async function __PRIVATE_applyDocChanges(e2, t3, n3, r3) {
    ...
    i2.Cs && (i2 = await __PRIVATE_localStoreExecuteQuery(
      e2.localStore,
      t3.query,
      false
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, r) {
  ...
  null !== s ? ("pending" === n ? await __PRIVATE_fillWritePipeline(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (__PRIVATE_processUserCallback(i, t, r || null), __PRIVATE_triggerPendingWritesCallbacks(i, t), function __PRIVATE_localStoreRemoveCachedMutationBatchMetadata(e2, t2) {
    ...
    Su: n
  }), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(i, s)) : __PRIVATE_logDebug(sn, "Cannot apply mutation batch with id: " + t);
}
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r.gu) {
    ...
    for (const e2 of n)
      r.Iu.has(e2) && await __PRIVATE_localStoreReleaseTarget(
        r.localStore,
        e2,
        false
      ).then(() => {
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(e, t, false), this.xu = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
    ...
    }, await this.sharedClientState.start()), await this.persistence.Ji(async (e2) => {
    ...
    if (e._uninitializedComponentsProvider) {
      ...
      try {
        ...
        if (!function __PRIVATE_canFallbackFromIndexedDbError(e2) {
          return "FirebaseError" === e2.name ? e2.code === N.FAILED_PRECONDITION || e2.code === N.UNIMPLEMENTED : !("undefined" != typeof DOMException && e2 instanceof DOMException) || 22 === e2.code || 20 === e2.code || 11 === e2.code;
        }(n))
          throw n;
...
function __PRIVATE_firestoreClientEnableNetwork(e) {
  return e.asyncQueue.enqueue(async () => {
    ...
    return t.setNetworkEnabled(true), function __PRIVATE_remoteStoreEnableNetwork(e2) {
      ...
      return t2.Ea.delete(0), __PRIVATE_enableNetworkInternal(t2);
    }(n);
  });
}
function __PRIVATE_firestoreClientDisableNetwork(e) {
  return e.asyncQueue.enqueue(async () => {
    ...
    return t.setNetworkEnabled(false), async function __PRIVATE_remoteStoreDisableNetwork(e2) {
      const t2 = __PRIVATE_debugCast(e2);
      t2.Ea.add(0), await __PRIVATE_disableNetworkInternal(t2), t2.Ra.set("Offline");
    }(n);
  });
}
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    __PRIVATE_debugCast(e2).Ca.add(t2), t2.next();
...
var FirestoreSettingsImpl = class {
  constructor(e) {
    ...
    if (void 0 === e.host) {
      ...
      this.host = e.host, this.ssl = (_a = e.ssl) != null ? _a : un;
    ...
    __PRIVATE_validateIsNotUsedTogether("experimentalForceLongPolling", e.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", e.experimentalAutoDetectLongPolling), this.experimentalForceLongPolling = !!e.experimentalForceLongPolling, this.experimentalForceLongPolling ? this.experimentalAutoDetectLongPolling = false : void 0 === e.experimentalAutoDetectLongPolling ? this.experimentalAutoDetectLongPolling = true : this.experimentalAutoDetectLongPolling = !!e.experimentalAutoDetectLongPolling, this.experimentalLongPollingOptions = __PRIVATE_cloneLongPollingOptions((_b = e.experimentalLongPollingOptions) != null ? _b : {}), function __PRIVATE_validateLongPollingOptions(e2) {
...
var Firestore = class extends Firestore$1 {
  constructor(e, t, n, r) {
    super(e, t, n, r), this.type = "firestore", this._queue = new __PRIVATE_AsyncQueueImpl(), this._persistenceKey = (r == null ? void 0 : r.name) || "[DEFAULT]";
  }
  async _terminate() {
...
function onSnapshotResume(e, t, ...n) {
  const r = getModularInstance(e), i = function __PRIVATE_normalizeSnapshotJsonFields(e2) {
    const t2 = {
      bundle: "",
      bundleName: "",
      bundleSource: ""
